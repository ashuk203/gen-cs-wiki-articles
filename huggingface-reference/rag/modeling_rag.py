        ...
        if encoder_outputs is None:
            ...
            if has_to_retrieve:
                ...
                if self.context_encoder_training:
                    ...
                    # I am not exactly sure what the below two variables are....
...
@add_start_docstrings_to_model_forward(
    """
    A RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass. (The first model from the paper)
    """,
    RAG_START_DOCSTRING,
)
...
@add_start_docstrings_to_model_forward(
    """
    A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass. (The second model from the paper)
    """,
    RAG_START_DOCSTRING,
)
